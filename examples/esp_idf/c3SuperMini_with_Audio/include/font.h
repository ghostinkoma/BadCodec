/**
 * @file  font.h
 * @brief 8x8 等幅 ASCII フォント (0x20〜0x7E)
 *
 * 各文字は 8バイト。1バイト = 1行(上から)。
 * bit7=左端, bit0=右端。
 */
#ifndef FONT_H_
#define FONT_H_

/* FONT_ROWS: 文字の行数 (旧 FONT_H, draw.c から参照) */

#include <stdint.h>

/* 文字コードオフセット */
#define FONT_FIRST  0x20  /* スペース */
#define FONT_LAST   0x7E  /* ~ */
#define FONT_W      8
#define FONT_ROWS     8

static const uint8_t g_font8x8[][8] = {
...
/* 0x45 'E' */ {0xFE,0x62,0x68,0x78,0x68,0x62,0x7E,0x00},
...
/* 0x5A 'Z' */ {0xFE,0xC6,0x8C,0x18,0x32,0x66,0x7E,0x00},
