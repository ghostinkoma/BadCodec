 ...
 */
  ...
  *
  * adpcm_task(priority=4) は player_task(5) が I2C flush (~23ms) している
  * 間は動けない。その間に消費されるサンプル数: 16kHz × 35ms ≈ 560 samples。
  * RING_SIZE=4096 で 221ms 分 (3536 samples) の余裕がある。
  * メモリコスト: 4096 × 2 bytes = 8KB (RAM 残量 ~313KB で問題なし)
  * ============================================================ */
 #define ADPCM_RING_SIZE   4096U
